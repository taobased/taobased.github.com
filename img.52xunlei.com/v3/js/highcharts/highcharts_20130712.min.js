...
shortMonths:"Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),weekdays:"Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","),decimalPoint:".",numericSymbols:"kw,M,G,T,P,E".split(","),resetZoom:"Reset zoom",resetZoomTitle:"Reset zoom level 1:1",thousandsSep:","},global:{useUTC:!0,canvasToolsURL:"http://code.highcharts.com/3.0.1/modules/canvas-tools.js",VMLRadialGradientURL:"http://code.highcharts.com/3.0.1/gfx/vml-radial-gradient.png"},chart:{borderColor:"#4572A7",borderRadius:5,
...
position:"relative",top:"1em"},style:{position:"absolute",backgroundColor:"white",opacity:0.5,textAlign:"center"}},tooltip:{enabled:!0,animation:Z,backgroundColor:"rgba(255, 255, 255, .85)",borderWidth:1,borderRadius:3,dateTimeLabelFormats:{millisecond:"%A, %b %e, %H:%M:%S.%L",second:"%A, %b %e, %H:%M:%S",minute:"%A, %b %e, %H:%M",hour:"%A, %b %e, %H:%M",day:"%A, %b %e, %Y",week:"Week from %A, %b %e, %Y",month:"%B %Y",year:"%Y"},headerFormat:'<b>'+(location.href.indexOf('/index/') > -1 || location.href.indexOf('/trend/') > -1 ? '' : '《')+'{point.key}'+(location.href.indexOf('/index/') > -1 || location.href.indexOf('/trend/') > -1 ? '' : '》')+'</b>',
pointFormat:'<br/><span style="color:{series.color};font-size:12px;font-weight:bold;">'+(location.href.indexOf('/boxoffice/') > -1 ? '' : '《')+'{series.name}'+(location.href.indexOf('/boxoffice/') > -1 ? ' ' : '》')+'</span><span style="font-size:14px;font-weight:bold;font-family:verdana;">{point.y}'+(location.href.indexOf('/index/') > -1 || location.href.indexOf('/boxoffice/') > -1 ? '' : '%')+'</span>',shadow:!0,snap:Kb?25:10,style:{color:"#333333",cursor:"default",fontSize:"12px",padding:"8px",whiteSpace:"nowrap"}},credits:{enabled:!1,text:"(c) 52xunlei.com",href:"http://www.52xunlei.com/",position:{align:"right",x:-10,verticalAlign:"bottom",y:-5},style:{cursor:"pointer",color:"#909090",fontSize:"9px"}}};var X=N.plotOptions,W=X.line;Hb();var ma=function(a){var b=[],c,d;(function(a){a&&a.stops?d=Ka(a.stops,
